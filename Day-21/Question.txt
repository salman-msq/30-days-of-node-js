...
First register for the event: Register Here

Form to create team: Team Creation Form. You can look for team members in the Node.js Project Building channel: Discord Channel (note: only one of your team members has to fill this form)

Come up with a theme around the project that you wish to build. The project has to be built during the time of the event.

As you start to participate from 21st Feb onwards, create a new forum post in the forum channel #nodejs-project-building-challenge-forum with the title as - <teamname>--<DiscordUsername1>--<DiscordUsername2> (if there are two members) or <teamname>--<DiscordUsername1> if there is one team member.
...
Link to join the forum channel is as follows: Forum Channel

Where Can I Reach Out in Case of Questions?
We have set up a help desk for the Node.js Project building challenge. The name of the channel is #helpdesk-nodejs-project-building-challenge: Help Desk Channel
...
Can't wait to see you there! Cheers, Scaler Discord Community